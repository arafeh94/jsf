...
public class PageRankAnalysis extends DataAnalysisBase {

    @Override
    public Table analyse() {
        Table table = new Table("Page Rank Results");
        try {
            for (Pair<String, Double> pair : graphNodeBll.pageRank(this.project.getId())) {
